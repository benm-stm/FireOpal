...
# host = http://crx2113.cro.st.com ( Web application to be tested )
...
# project = gitproject ( Unix name of a project )
# project_id = 982 ( Id of the project )
# tracker = Bug ( Name of a tracker )
# tracker_shortname = trk ( Shortname of the tracker )
# docman_root_id = 1 ( Id of the root of docman )
# project_name = TestGit ( The Project name )
#--- End Conf
...
describe "Validation_STCodexQA_Tuleap5.3" do

    before(:all) do
        @valid = Configuration.new
        @setup  = JSON.parse('{"host":{"value":"http:\/\/crx2113.cro.st.com","description":"Web application to be tested","type":"text"},"client":{"value":"10.157.12.139","description":"Ip address of the client machine","type":"text"},"browser":{"value":"firefox","description":"Browser to be launched","type":"text"},"user":{"value":"disciplus_simplex","description":"Login of a user","type":"text"},"password":{"value":"DSeevaT","description":"Password of the user","type":"password"},"project":{"value":"gitproject","description":"Unix name of a project","type":"text"},"project_id":{"value":"982","description":"Id of the project","type":"text"},"tracker":{"value":"Bug","description":"Name of a tracker","type":"text"},"tracker_shortname":{"value":"trk","description":"Shortname of the tracker","type":"text"},"docman_root_id":{"value":"1","description":"Id of the root of docman","type":"text"},"project_name":{"value":"TestGit","description":"The Project name","type":"text"}}')
        @valid.setup(@setup)
        @valid.login()
